...
import TermsOfUseImg from "@/assets/terms-of-use.webp";
...
const TermsOfUse = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* Hero section */}
      <div
        className="relative pt-40 pb-20 px-4 md:px-8 bg-cover bg-[80%_center] md:bg-center"
        style={{ backgroundImage: `url(${TermsOfUseImg})` }}
      >
        <div className="absolute inset-0 bg-[#1C0E2D]/30"></div>
        <div className="container mx-auto max-w-5xl text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6">Terms of Use</h1>
        </div>
      </div>

      {/* Content */}
      <div className="flex-grow container mx-auto max-w-5xl px-2 md:px-6 py-10">
        <div className="bg-white rounded-[20px] shadow-sm p-6 md:p-10 text-gray-700 text-[15px] md:text-[16px]">

          <h2 className="text-2xl font-bold text-[#3B194E] mb-4">AGREEMENT BETWEEN USER AND Cybertronium</h2>
          <p className="mb-4 leading-relaxed">
            The Cybertronium Web Site is comprised of various Web pages operated by Cybertronium.
          </p>
          <p className="mb-6 leading-relaxed">
            The Cybertronium Web Site is offered to you conditioned on your acceptance
            without modification of the terms, conditions, and notices contained herein. Your
            use of the Cybertronium Web Site constitutes your agreement to all such terms,
            conditions, and notices.
          </p>

          <h2 className="text-2xl font-bold text-[#3B194E] mt-10 mb-4">MODIFICATION OF THESE TERMS OF USE</h2>
          <p className="mb-6 leading-relaxed">
            Cybertronium reserves the right to change the terms, conditions, and notices
            under which the Cybertronium Web Site is offered, including but not limited
            to the charges associated with the use of the Cybertronium Web Site.
          </p>

          <h2 className="text-2xl font-bold text-[#3B194E] mt-10 mb-4">LINKS TO THIRD PARTY SITES</h2>
          <p className="mb-6 leading-relaxed">
            The Cybertronium Web Site may contain links to other Web Sites ("Linked Sites").
            The Linked Sites are not under the control of Cybertronium and Cybertronium
            ...
            Cybertronium is not responsible for webcasting or any other form of transmission
            received from any Linked Site. Cybertronium is providing these links to you
            only as a convenience, and the inclusion of any link does not imply endorsement
            by Cybertronium of the site or any association with its operators.
          </p>

          <h2 className="text-2xl font-bold text-[#3B194E] mt-10 mb-4">NO UNLAWFUL OR PROHIBITED USE</h2>
          <p className="mb-6 leading-relaxed">
            As a condition of your use of the Cybertronium Web Site, you warrant to Cybertronium
            that you will not use the Cybertronium Web Site for any purpose that is unlawful
            or prohibited by these terms, conditions, and notices. You may not use the Cybertronium
            Web Site in any manner which could damage, disable, overburden, or impair the Cybertronium
            Web Site or interfere with any other party's use and enjoyment of the Cybertronium
            Web Site. You may not obtain or attempt to obtain any materials or information through
            any means not intentionally made available or provided for through the Cybertronium
            Web Sites.
          </p>

          <h2 className="text-2xl font-bold text-[#3B194E] mt-10 mb-4">USE OF COMMUNICATION SERVICES</h2>
          <p className="mb-4 leading-relaxed">
            The Cybertronium Web Site may contain bulletin board services, chat areas,
          ...
          <p className="mb-4 leading-relaxed">
            Cybertronium has no obligation to monitor the Communication Services. However,
            Cybertronium reserves the right to review materials posted to a Communication
            Service and to remove any materials in its sole discretion. Cybertronium
          ...
          <p className="mb-4 leading-relaxed">
            Cybertronium reserves the right at all times to disclose any information
            ...
            whole or in part, in Cybertronium's sole discretion.
          </p>
          <p className="mb-4 leading-relaxed">
            Always use caution when giving out any personally identifying information about
            yourself or your children in any Communication Service. Cybertronium does
            not control or endorse the content, messages or information found in any Communication
            Service and, therefore, Cybertronium specifically disclaims any liability
            with regard to the Communication Services and any actions resulting from your participation
            in any Communication Service. Managers and hosts are not authorized Cybertronium
            spokespersons, and their views do not necessarily reflect those of Cybertronium.
          </p>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-[#3B194E] mt-10 mb-4">MATERIALS PROVIDED TO Cybertronium OR POSTED AT ANY Cybertronium WEB SITE</h2>
          <p className="mb-4 leading-relaxed">
            Cybertronium does not claim ownership of the materials you provide to Cybertronium
            (including feedback and suggestions) or post, upload, input or submit to any Cybertronium
            Web Site or its associated services (collectively "Submissions"). However, by posting,
            uploading, inputting, providing or submitting your Submission you are granting Cybertronium,
          ...
          <p className="mb-4 leading-relaxed">
            ...
            herein. Cybertronium is under no obligation to post or use any Submission
            you may provide and may remove any Submission at any time in Cybertronium's
            sole discretion.
          </p>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-[#3B194E] mt-10 mb-4">LIABILITY DISCLAIMER</h2>
          <p className="mb-4 leading-relaxed">
            THE INFORMATION, SOFTWARE, PRODUCTS, AND SERVICES INCLUDED IN OR AVAILABLE THROUGH
            THE Cybertronium WEB SITE MAY INCLUDE INACCURACIES OR TYPOGRAPHICAL ERRORS.
            CHANGES ARE PERIODICALLY ADDED TO THE INFORMATION HEREIN. Cybertronium AND/OR
            ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN THE Cybertronium WEB
            SITE AT ANY TIME. ADVICE RECEIVED VIA THE Cybertronium WEB SITE SHOULD NOT
          ...
          <p className="mb-4 leading-relaxed">
            Cybertronium AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE SUITABILITY,
            RELIABILITY, AVAILABILITY, TIMELINESS, AND ACCURACY OF THE INFORMATION, SOFTWARE,
            PRODUCTS, SERVICES AND RELATED GRAPHICS CONTAINED ON THE Cybertronium WEB
            ...
            IS" WITHOUT WARRANTY OR CONDITION OF ANY KIND. Cybertronium AND/OR ITS SUPPLIERS
          ...
          <p className="mb-6 leading-relaxed">
            TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL Cybertronium
            ...
            USE OR PERFORMANCE OF THE Cybertronium WEB SITE, WITH THE DELAY OR INABILITY
            TO USE THE Cybertronium WEB SITE OR RELATED SERVICES, THE PROVISION OF OR
            FAILURE TO PROVIDE SERVICES, OR FOR ANY INFORMATION, SOFTWARE, PRODUCTS, SERVICES
            AND RELATED GRAPHICS OBTAINED THROUGH THE Cybertronium WEB SITE, OR OTHERWISE
            ARISING OUT OF THE USE OF THE Cybertronium WEB SITE, WHETHER BASED ON CONTRACT,
            TORT, NEGLIGENCE, STRICT LIABILITY OR OTHERWISE, EVEN IF Cybertronium OR
            ...
            WITH ANY PORTION OF THE Cybertronium WEB SITE, OR WITH ANY OF THESE TERMS
            OF USE, YOUR SOLE AND EXCLUSIVE REMEDY IS TO DISCONTINUE USING THE Cybertronium
            WEB SITE.
          </p>

          <p className="mb-6 leading-relaxed">
            SERVICE CONTACT : <a href="mailto:clementarul@cybertronium.com" className="text-[#CA1C69] font-medium hover:underline">clementarul@cybertronium.com</a>
          </p>

          <h2 className="text-2xl font-bold text-[#3B194E] mt-10 mb-4">TERMINATION/ACCESS RESTRICTION</h2>
          <p className="mb-6 leading-relaxed">
            Cybertronium reserves the right, in its sole discretion, to terminate your
            access to the Cybertronium Web Site and the related services or any portion
            ...
            Cybertronium Web Site. Use of the Cybertronium Web Site is unauthorized
            ...
            Cybertronium as a result of this agreement or use of the Cybertronium
            Web Site. Cybertronium's performance of this agreement is subject to existing
            laws and legal process, and nothing contained in this agreement is in derogation
            of Cybertronium's right to comply with governmental, court and law enforcement
            requests or requirements relating to your use of the Cybertronium Web Site
            or information provided to or gathered by Cybertronium with respect to such
            ...
            agreement between the user and Cybertronium with respect to the Cybertronium
            Web Site and it supersedes all prior or contemporaneous communications and proposals,
            whether electronic, oral or written, between the user and Cybertronium with
            respect to the Cybertronium Web Site. A printed version of this agreement
          ...
          <h2 className="text-2xl font-bold text-[#3B194E] mt-10 mb-4">COPYRIGHT AND TRADEMARK NOTICES:</h2>
          <p className="mb-6 leading-relaxed">
            All contents of the Cybertronium Web Site are: Copyright {new Date().getFullYear()} by Cybertronium Sdn. Bhd. and/or
            its suppliers. All rights reserved.
          </p>

          <h2 className="text-2xl font-bold text-[#3B194E] mt-10 mb-4">TRADEMARKS</h2>
          <p className="mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-[#3B194E] mt-10 mb-4">NOTICES AND PROCEDURE FOR MAKING CLAIMS OF COPYRIGHT INFRINGEMENT</h2>
          <p className="mb-6 leading-relaxed">
