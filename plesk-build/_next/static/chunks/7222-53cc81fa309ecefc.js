"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[7222],{11626:(e,t,r)=>{r.d(t,{TagInput:()=>l});var a=r(95155),i=r(12115),o=r(60529),n=r(33210);function l({name:e,defaultValue:t="",placeholder:r="Add a tag..."}){let[s,d]=(0,i.useState)(t.split(",").map(e=>e.trim()).filter(Boolean)),[p,c]=(0,i.useState)("");return(0,a.jsxs)("div",{className:"flex flex-col gap-2",children:[(0,a.jsx)("div",{className:"flex flex-wrap gap-2",children:s.map(e=>(0,a.jsxs)("div",{className:"flex items-center gap-1 bg-slate-100 text-slate-800 px-2 py-1 rounded-md text-xs font-medium dark:bg-slate-800 dark:text-slate-200",children:[(0,a.jsx)("span",{children:e}),(0,a.jsx)("button",{type:"button",onClick:()=>{d(s.filter(t=>t!==e))},className:"text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200",children:(0,a.jsx)(n.A,{className:"h-3 w-3"})})]},e))}),(0,a.jsx)(o.Input,{type:"text",placeholder:r,value:p,onChange:e=>c(e.target.value),onKeyDown:e=>{if("Enter"===e.key||","===e.key){e.preventDefault();let t=p.trim();t&&!s.includes(t)&&d([...s,t]),c("")}},className:"h-9 text-sm",onBlur:()=>{let e=p.trim();e&&!s.includes(e)&&d([...s,e]),c("")}}),(0,a.jsx)("input",{type:"hidden",name:e,value:s.join(", ")})]})}},18065:(e,t,r)=>{r.d(t,{ClientForm:()=>o});var a=r(95155),i=r(12115);function o({action:e,children:t,className:r}){let[n,l]=(0,i.useState)(null),s=(0,i.useRef)(null);async function d(t){t.preventDefault(),l(null);let r=new FormData(t.currentTarget);try{let t=await e(r);t?.error&&l(t.error)}catch(e){if(e.message&&e.message.includes("NEXT_REDIRECT"))throw e;console.error(e)}}return(0,i.useEffect)(()=>{n&&s.current&&s.current.scrollIntoView({behavior:"smooth",block:"center"})},[n]),(0,a.jsxs)("form",{onSubmit:d,className:r,children:[n&&(0,a.jsx)("div",{ref:s,className:"mb-4 p-3 rounded-md bg-red-50 border border-red-200 text-red-600 text-sm",children:n}),t]})}},33807:(e,t,r)=>{r.d(t,{Label:()=>o});var a=r(95155);r(12115);var i=r(40980);function o({className:e,...t}){return(0,a.jsx)("label",{"data-slot":"label",className:(0,i.cn)("flex items-center gap-2 text-sm leading-none font-medium select-none group-data-[disabled=true]:pointer-events-none group-data-[disabled=true]:opacity-50 peer-disabled:cursor-not-allowed peer-disabled:opacity-50",e),...t})}},56600:(e,t,r)=>{r.d(t,{ImageInputWithUpload:()=>u});var a=r(95155),i=r(12115),o=r(6296),n=r(77531),l=r(17243),s=r(33210);let d=3;function p({onUploadSuccess:e,maxSizeMB:t=d}){let[r,c]=(0,i.useState)(!1),[m,x]=(0,i.useState)(!1),[h,u]=(0,i.useState)(null),b=(0,i.useCallback)(e=>{e.preventDefault(),e.stopPropagation(),"dragenter"===e.type||"dragover"===e.type?c(!0):"dragleave"===e.type&&c(!1)},[]),g=async r=>{if(u(null),r.size>1024*t*1024)return void u(`File size exceeds the ${t}MB limit.`);if(!r.type.startsWith("image/"))return void u("Unsupported file type. Please upload an image.");x(!0);try{let t=new FormData;t.append("file",r);let a=await fetch("/api/upload",{method:"POST",body:t}),i=await a.json();if(!a.ok)throw Error(i.error||"Failed to upload image");e(i.asset.url,i.asset)}catch(e){u(e.message||"An error occurred during upload.")}finally{x(!1)}},w=(0,i.useCallback)(e=>{e.preventDefault(),e.stopPropagation(),c(!1);let t=Array.from(e.dataTransfer.files);t.length>0&&g(t[0])},[]);return(0,a.jsxs)("div",{className:"w-full",children:[(0,a.jsxs)("div",{className:`relative flex flex-col items-center justify-center w-full h-64 border-2 border-dashed rounded-lg transition-colors ${r?"border-primary bg-primary/5":"border-muted-foreground/25 hover:bg-muted/50"}`,onDragEnter:b,onDragLeave:b,onDragOver:b,onDrop:w,children:[(0,a.jsx)("input",{type:"file",className:"absolute inset-0 w-full h-full opacity-0 cursor-pointer",onChange:e=>{let t=Array.from(e.target.files||[]);t.length>0&&g(t[0])},accept:"image/*",disabled:m}),(0,a.jsxs)("div",{className:"flex flex-col items-center justify-center pt-5 pb-6 text-center px-4",children:[m?(0,a.jsx)(o.A,{className:"w-10 h-10 mb-3 text-muted-foreground animate-spin"}):(0,a.jsx)(n.A,{className:"w-10 h-10 mb-3 text-muted-foreground"}),(0,a.jsxs)("p",{className:"mb-2 text-sm text-muted-foreground",children:[(0,a.jsx)("span",{className:"font-semibold text-foreground",children:"Click to upload"})," or drag and drop"]}),(0,a.jsxs)("p",{className:"text-xs text-muted-foreground mt-2 max-w-xs",children:["Supported formats: Images only (Max ",t,"MB)."]}),(0,a.jsxs)("div",{className:"mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300 rounded-md text-xs border border-blue-100 dark:border-blue-800/30 flex items-start gap-2 max-w-xs text-left",children:[(0,a.jsx)(l.A,{className:"w-4 h-4 shrink-0 mt-0.5"}),(0,a.jsxs)("span",{children:[(0,a.jsx)("strong",{children:"Pro Tip:"})," We highly recommend using the ",(0,a.jsx)("strong",{children:"WebP"})," format for better quality and significant space retention."]})]})]})]}),h&&(0,a.jsxs)("div",{className:"mt-2 text-sm text-destructive flex items-center gap-1",children:[(0,a.jsx)(s.A,{className:"w-4 h-4"}),h]})]})}var c=r(68743),m=r(60529),x=r(33807),h=r(89239);function u({name:e,label:t,defaultUrl:r="",placeholder:o,description:n}){let[l,s]=(0,i.useState)("url"),[d,b]=(0,i.useState)(r),[g,w]=(0,i.useState)(!!r),[f,v]=(0,i.useState)("url"),[k,j]=(0,i.useState)(!1),y=(e,t)=>{b(e),w(!0),v(t),s("url")};return(0,a.jsxs)("div",{className:"space-y-2 border border-slate-100 dark:border-slate-800 rounded-md p-3 bg-slate-50/50 dark:bg-slate-900/20 transition-colors duration-200",onDragEnter:e=>{e.dataTransfer.types.includes("Files")&&"url"===l&&!g&&s("upload")},onDragOver:e=>{e.dataTransfer.types.includes("Files")&&e.preventDefault()},children:[(0,a.jsxs)("div",{className:"flex items-center justify-between",children:[(0,a.jsx)(x.Label,{className:"text-xs font-semibold",children:t}),(0,a.jsxs)("div",{className:"flex gap-1 bg-slate-100 dark:bg-slate-800 p-0.5 rounded-md",children:[(0,a.jsx)(h.Button,{type:"button",variant:"ghost",size:"sm",disabled:g,onClick:()=>s("url"),className:`h-6 px-2 text-[10px] ${(g?"url"===f:"url"===l)?"bg-white dark:bg-slate-950 shadow-sm":""} ${g?"opacity-50":""}`,children:"URL"}),(0,a.jsx)(h.Button,{type:"button",variant:"ghost",size:"sm",disabled:g,onClick:()=>s("upload"),className:`h-6 px-2 text-[10px] ${(g?"upload"===f:"upload"===l)?"bg-white dark:bg-slate-950 shadow-sm":""} ${g?"opacity-50":""}`,children:"Upload"}),(0,a.jsx)(h.Button,{type:"button",variant:"ghost",size:"sm",disabled:g,onClick:()=>j(!0),className:`h-6 px-2 text-[10px] ${g&&"library"===f?"bg-white dark:bg-slate-950 shadow-sm":""} ${g?"opacity-50":""}`,children:"Library"})]})]}),(0,a.jsx)("input",{type:"hidden",name:e,value:d}),"url"===l?(0,a.jsxs)("div",{className:"space-y-2",children:[(0,a.jsxs)("div",{className:"flex gap-2",children:[(0,a.jsx)(m.Input,{value:d,onChange:e=>b(e.target.value),placeholder:o||"https://example.com/image.jpg",className:`h-9 text-sm bg-white dark:bg-slate-950 flex-1 ${g?"cursor-default text-slate-500":""}`,readOnly:g}),d&&(0,a.jsx)(h.Button,{type:"button",variant:"outline",size:"sm",onClick:()=>{b(""),w(!1),v("url")},className:"h-9 shrink-0 text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-900/20",children:"Clear"})]}),g&&(0,a.jsxs)("p",{className:"text-[10px] text-slate-500 mt-1.5 flex items-center gap-1 px-1",children:[(0,a.jsx)("span",{className:"w-3 h-3 inline-flex items-center justify-center rounded-full border border-slate-400 text-[8px] font-bold",children:"i"}),"This URL is read-only. Click Clear to change it."]}),d&&(0,a.jsx)("div",{className:"mt-2 relative h-32 w-full rounded-md overflow-hidden border border-slate-200 dark:border-slate-800",children:(0,a.jsx)("img",{src:d,alt:"Preview",className:"object-contain w-full h-full",onError:e=>{e.currentTarget.style.display="none"}})})]}):(0,a.jsx)("div",{className:"pt-1",children:(0,a.jsx)(p,{onUploadSuccess:e=>y(e,"upload")})}),n&&(0,a.jsx)("p",{className:"text-[11px] text-slate-400 mt-1",children:n}),k&&(0,a.jsx)("div",{className:"fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 !m-0",children:(0,a.jsxs)("div",{className:"bg-white dark:bg-slate-950 rounded-xl max-w-5xl w-full max-h-[85vh] overflow-hidden flex flex-col shadow-2xl border border-slate-200 dark:border-slate-800",children:[(0,a.jsxs)("div",{className:"px-5 py-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center shrink-0",children:[(0,a.jsxs)("h3",{className:"font-semibold text-slate-900 dark:text-slate-100",children:["Select ",t]}),(0,a.jsx)(h.Button,{size:"sm",variant:"ghost",onClick:()=>j(!1),children:"Close"})]}),(0,a.jsx)("div",{className:"p-5 overflow-auto flex-1",children:(0,a.jsx)(c.MediaLibrary,{onSelect:e=>{y(e,"library"),j(!1)}})})]})})]})}},86694:(e,t,r)=>{r.d(t,{MarkdownEditor:()=>N});var a=r(95155),i=r(12115),o=r(19756),n=r(89239),l=r(68743);function s({level:e}){return(0,a.jsxs)("span",{style:{fontSize:11,fontWeight:700,fontFamily:"inherit",letterSpacing:"-0.02em",lineHeight:1},children:["H",e]})}let d=e=>({name:`heading${e}`,keyCommand:`heading${e}`,buttonProps:{"aria-label":`Heading ${e}`,title:`Heading ${e}`},icon:(0,a.jsx)(s,{level:e}),execute(t,r){let a="#".repeat(e)+" ",i=t.selectedText||"Heading";r.replaceSelection(a+i)}}),p={name:"table",keyCommand:"table",buttonProps:{"aria-label":"Insert table",title:"Insert table"},icon:(0,a.jsx)("svg",{viewBox:"0 0 16 16",width:"14",height:"14",fill:"currentColor",children:(0,a.jsx)("path",{d:"M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2zm6 0v4h4V2H6zm4 5H6v4h4V7zm1 4h3V7h-3v4zm0-5h3V2h-3v4zM5 2H2v4h3V2zM2 7v4h3V7H2zm0 5v2h3v-2H2zm4 2h4v-2H6v2zm5 0h3v-2h-3v2z"})}),execute(e,t){t.replaceSelection("\n| Header 1 | Header 2 | Header 3 |\n|----------|----------|----------|\n| Cell     | Cell     | Cell     |\n| Cell     | Cell     | Cell     |\n")}},c={name:"callout",keyCommand:"callout",buttonProps:{"aria-label":"Callout / Note block",title:"Note callout"},icon:(0,a.jsxs)("svg",{viewBox:"0 0 16 16",width:"14",height:"14",fill:"currentColor",children:[(0,a.jsx)("path",{d:"M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"}),(0,a.jsx)("path",{d:"m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"})]}),execute(e,t){let r=e.selectedText||"Important note here";t.replaceSelection(`
> 💡 **Note:** ${r}
